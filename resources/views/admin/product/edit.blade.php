                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="type" class="form-select" required>
                                        <option value="food" {{ $product->type === 'food' ? 'selected' : '' }}>Food
                                        </option>
                                        <option value="drink" {{ $product->type === 'drink' ? 'selected' : '' }}>Drink
                                        </option>
                                    </select>
                                </div>
                                    ...
                                    <select name="addon_ids[]" id="addons" class="form-select" multiple>
                                        @foreach ($addons as $addon)
                                            <option value="{{ $addon->id }}"
                                                {{ in_array($addon->id, old('addon_ids', $productAddonIds ?? [])) ? 'selected' : '' }}>
